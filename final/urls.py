...
from adminPanel.views import student_details, performance_distribution, learning_style_distribution, completion_over_time, quiz_performance, top_performers, student_quizzes, student_progress_details
